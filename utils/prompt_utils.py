...
def build_list_unprompted_prompt(
    ...
    return (
        ...
        "Focus only on elements that affect creative direction — unexpected additions, "
        "deviations from the reference, or choices that change the feel or intent of "
        "the output. Apply these rules strictly:\n\n"
        ...
        "- Skip fine-grained detail (textures, micro-expressions, minor lighting variation) "
        "unless they represent a clear departure from what was prompted or referenced.\n"
        "- Return at most 10 items. If fewer than 10 qualify, return only those.\n\n"
